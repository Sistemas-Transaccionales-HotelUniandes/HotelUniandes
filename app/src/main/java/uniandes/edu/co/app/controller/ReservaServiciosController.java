...
public class ReservaServiciosController {
    ...
    public String reservaSalonSubmit(@ModelAttribute ReservaSalon reserva, Model model) {
        reservaSalonRepository.insertarreservaSalon(reserva.getId().getSalon().getId(), reserva.getId().getCuenta().getHabitacion().getId(), reserva.getHoraIn(), reserva.getDia(),  reserva.getDuracion(), reserva.getCuentaReserva().getId().getReserva().getId());
        return "redirect:/reservaServicios/Salon";
    }
    ...
    public String reservaSalonActualizar(@ModelAttribute ReservaSalon reserva, Model model) {
        reservaSalonRepository.actualizarreservaSalon(reserva.getId().getSalon().getId(), reserva.getId().getCuenta().getHabitacion().getId(), reserva.getHoraIn(), reserva.getDia(),  reserva.getDuracion(), reserva.getCuentaReserva().getId().getReserva().getId());
        return "redirect:/reservaServicios/Salon";
    }
